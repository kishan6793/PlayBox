...
export const USERS_URL = "https://playbox-5v09.onrender.com";

// URL for genre-related API requests (e.g., fetching genres, adding new genres)
export const GENRE_URL = "https://playbox-5v09.onrender.com";

// URL for movie-related API requests (e.g., CRUD operations for movies)
export const MOVIE_URL = "https://playbox-5v09.onrender.com";
