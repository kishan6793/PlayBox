...
function About() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-black to-gray-900 text-white">
      {/* Hero Section: Displays the page title and introduction */}
      <div className="container mx-auto px-4 py-16">
        ...
        {/* Features Grid: Highlights key platform features */}
        ...
        {/* Team Section: Displays the team members */}
        <div className="mb-20">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <TeamMember
              image={kishan}
              name="Kishan Patel"
              // Add role if needed in the future
            />
        ...
        {/* Tech Stack Section: Displays the technologies used */}
        <div className="mb-20">
          <h2 className="text-3xl font-bold text-center mb-12">
...
// TeamMember Component: Renders a single team member profile
...
// TechItem Component: Renders a single tech stack item
